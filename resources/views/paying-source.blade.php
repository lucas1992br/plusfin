                ...
                @slot('data')
                    @foreach ($methods ?? '' as $item)
                        <tr>
                            ...
                            <td title="Ações">
                                <a role="button" class="delete-row-js" data-route="{{route('fonte-pagante.destroy',$item->id)}}">
                                    <i class="fa fa-trash _i text-danger"></i>
                                </a>
                                <a role="button" class="edit-row-js" data-route="{{route('fonte-pagante.show', $item->id)}}">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="register-modal">Cadastro de Fonte Pagante</h5>
