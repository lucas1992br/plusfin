...
<x-aplicativo-layout>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('origem.index') }}" method="get">
                @csrf
                <div>
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <select class="form-select-item select form-control form-control-sm form-control form-control-sm-sm" name="costcenter_search">
                    ...
                    @foreach ($methods ?? '' as $item)
                        <tr>
                            ...
                            <td title="Ações">
                                ...
                                <a role="button" class="edit-row-js" data-route="{{route('origem.show', $item->id)}}">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="register-modal">Cadastro Origem</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <form method="POST" action="{{ route('origem.store') }}" class="needs-validation" novalidate>
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label>Tipo</label>
                                <select class="form-select-item form-control form-control-sm" id="tipo" name="tipo" required="true" onchange="TipoOrigem()">
                                    <option value="">Selecione um tipo</option>
                            ...
                            <div class="col-md-4 mb-3">
                                <label>Centro de Custo</label>
                                <select class="form-select-item select form-control form-control-sm" id="costcenter" name="costcenter" searchable="Search here.." required="true">
    ...
    <div class="modal fade" id="edit-item-modal" tabindex="-1" role="dialog" aria-labelledby="update-modal" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="update-modal">Editar Origem</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <form id="edit-form" class="needs-validation" method="POST" novalidate>
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label>Centro de Custo</label>
                                <select class="form-select-item select form-control form-control-sm" id="edit-costcenter" name="costcenter" required="true">
                                    <option value="">Selecione um Centro de Custo</option>
                                    @foreach($costcenters as $item)
                                        <option value="{{ $item->id }}">{{ $item->nome }}</option>
                                    @endforeach
...
<script type="text/javascript">
        ...
        $('.edit-row-js').on('click', function(e) {
            ...
            $.ajax({
                ...
                success: (response, textStatus, xhr) => {
                    ...
                    $('#edit-costcenter').val(response.costcenter_id);
                    $('#edit-tipo').val(response.tipo);
                    $('#edit-status').val(response.status);
                    $('#edit-form').attr('action', `origem/${editItemId}`);
    ...
    function TipoOrigem(){
        ...
        if(opcaoValor === 'Entrada'){
            document.getElementById('costcenter').style.display = 'none';
            document.getElementById('costcenter').required = false;
            console.log('Capiturado');
        } else {
            document.getElementById('costcenter').style.display = 'block';
