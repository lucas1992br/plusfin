                    ...
                    <div>
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="date" name="data_inicial_search" class="form-control-sm form-control small">
                            </div>
                            <div class="col">
                                <label>Data Final</label>
                                <input type="date" name="data_final_search" class="form-control-sm form-control small">
                            </div>                          
                            <div class="col">
                                <label>..</label></br>
                ...
                @slot('data')
                    @foreach ($methods ?? '' as $item)                
                        <tr class="small">
                            ...
                            <td title="{{$item->status}}" class="badge bg-warning text-white rounded align-middle">{{$item->status}}</td>
                            <td title="Ações">
